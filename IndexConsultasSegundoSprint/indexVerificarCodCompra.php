...
if(isset($_GET["verificarcodcompra"])){
    

    $codDetCompra=$_POST["codigoCompra"];

    $sqlQuery1   = ("SELECT DISTINCT codDetCompra FROM detallecompra WHERE codDetCompra='{$codDetCompra}'");
