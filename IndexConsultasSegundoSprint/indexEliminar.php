...
if (isset($_GET["borrar"])){
    ...
    $sqlProducto = mysqli_query($conexionBD,"DELETE FROM producto WHERE codProd=".$_GET["borrar"]." AND NOT EXISTS (SELECT * FROM detallecompra WHERE Producto_codProducto=".$_GET["borrar"].")");
